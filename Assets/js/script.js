...
var storedData = JSON.parse(localStorage.getItem('commentKey'));

var display = document.getElementById('potato');
...
$('#hour-9').find('button').click(function() {
  ...
  let userEntry = localStorage.getItem('commentKey');
  var hourNine = JSON.parse(localStorage.getItem('commentKey'));
